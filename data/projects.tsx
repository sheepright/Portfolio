...
const S3_BASE_URL =
  "https://portfolio-projects-sheep.s3.ap-northeast-2.amazonaws.com/public";
...
export const personalProjects: Project[] = [
  ...
  },
  {
    ...
    iconImage: `${S3_BASE_URL}/airport/airport.png`,
    images: [
      `${S3_BASE_URL}/airport/profile.png`,
      `${S3_BASE_URL}/airport/command.png`,
      `${S3_BASE_URL}/airport/help.png`,
      `${S3_BASE_URL}/airport/information.png`,
      `${S3_BASE_URL}/airport/exchange.png`,
    ],
    details: {
      overview:
...
export const teamProjects: Project[] = [
  {
    ...
    iconImage: `${S3_BASE_URL}/monoGlyph/monoGlyph.png`,
    videoEmbed: "https://www.youtube.com/embed/NnAXeprRV0w",
    details: {
      overview:
  ...
  },
  {
    ...
    iconImage: `${S3_BASE_URL}/studySwipe/studySwipe.png`,
    video: `${S3_BASE_URL}/studySwipe/video.mov`,
    details: {
      overview:
  ...
  },
  {
    ...
    iconImage: `${S3_BASE_URL}/ourVillage/ourVillage.png`,
    images: [`${S3_BASE_URL}/ourVillage/main.png`],
    details: {
      overview:
  ...
  },
  {
    ...
    iconImage: `${S3_BASE_URL}/typonic/typonic.png`,
    images: [
      `${S3_BASE_URL}/typonic/main.png`,
      `${S3_BASE_URL}/typonic/code.png`,
      `${S3_BASE_URL}/typonic/word.png`,
      `${S3_BASE_URL}/typonic/custum.png`,
      `${S3_BASE_URL}/typonic/custumTyping.png`,
      `${S3_BASE_URL}/typonic/result.png`,
      `${S3_BASE_URL}/typonic/result2.png`,
      `${S3_BASE_URL}/typonic/graph.png`,
      `${S3_BASE_URL}/typonic/rankingUpload.png`,
      `${S3_BASE_URL}/typonic/ranking.png`,
    ],
    details: {
      overview:
  ...
  },
  {
    ...
    figma:
      "https://www.figma.com/design/0LNY513MfpHwOwvu87yk80/zombuilder?node-id=0-1&t=caEU1ZD5W3SnnyvB-1",
    period: "2024.10 - 2024.11.30",
    team: "4명",
    role: "Frontend, Web Designer",
    iconImage: `${S3_BASE_URL}/zombilder/zombilder.png`,
    details: {
      overview:
